            ...
            <div class="auth-container entry-anim">
                <div class="auth-card premium-glass" style="max-height: 90vh; overflow-y: auto;">
                    ...
                    <div id="auth-form" style="margin-top: 20px;">
                        <div id="auth-error-msg" style="color: var(--gh-danger-ink); font-size: 12px; margin-bottom: 15px; display:none; background: rgba(255,77,77,0.1); padding: 12px; border-radius: 14px; font-weight: 600;"></div>
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px;">
                            ...
                            <button id="do-apple" class="social-btn-premium" style="background: var(--gh-ink); color: white; border: none;">
                        ...
                        <div style="text-align: center; margin-top: 20px; padding-top: 15px; border-top: 1px solid var(--gh-surface-2);">
